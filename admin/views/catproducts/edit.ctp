            ...
            <table class="input">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->Form->input('Catproduct.img',array('class'=>'text-input image-input datepicker','name' => 'userfile1'));?> &nbsp;<font color="#FF0000"> <a href="javascript:window.open('<?php echo DOMAINAD; ?>upload.php?ids=1','userfile1','width=500,height=300');window.history.go(1)" >[ upload ]</a> </font><font color="#FF0000">*</font>(jpg, jpeg, gif, png)
