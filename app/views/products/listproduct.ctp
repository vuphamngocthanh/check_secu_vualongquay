        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <section id="product-listitem" class="clearfix">
                <div class="listitem box_9">
                    <div class="row banner-list"><?php echo $cat['Catproduct']['content']?></div>
                    <h2><span class="titles"><?php echo $cat['Catproduct']['name']?></span>
                    </h2>
                    <div class="row is-flex">
                        <?php if($products){?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                            <div class="product">
                                ...
                                <div class="des-product"> <a href="<?php echo DOMAIN;?>detail/<?php echo $pr['Product']['alias'];?>.html" title="<?php echo $pr['Product']['title'];?>" class="trans-hover">
                                    ...
                                    </a><div class="masp"><strong>MS: </strong> <?php echo $pr['Product']['code'];?></div>
